...
#include <stdbool.h>
#include "mystd.h"
#include "da104-fy2024-npt01-examples.h"
#include "da104-fy2024-pt01-examples.h"
#include "da104-fy2024-npt02-examples.h"
#include "da104-fy2024-pt02-examples.h"

int da104_fy2024_examples_menu()
{
	...
	do
	{
		...
		printf("----------     DA104 - FY2024 - Proctored Test Examples     ----------");
		printf("\n\n");
		printf("\t1.  NPT-01\n");
		printf("\t2.  PT-01\n");
		printf("\t3.  NPT-02\n");
